...
@section('content')
    ...
    <form id='borrow' class="needs-validation" novalidate>
        ...
        <div class="form-group row">
            <label for="know_filling" class="col-sm-2 col-form-label"><svg xmlns="http://www.w3.org/2000/svg" width="16"
                    height="16" fill="currentColor" class="bi bi-question-square" viewBox="0 0 16 16">
                    <path
                        d="M14 1a1 1 0 0 1 1 1v12a1 1 0 0 1-1 1H2a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1zM2 0a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2z" />
                    <path
            ...
            <div class="col">
                <div class="form-check form-check">
                    <input class="form-check-input position-static" type="radio" name="know_filling" value="y"
                        aria-label="..." required><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
        ...
        <hr>
        <div class="form-group row">
            <label for="borrow_place" class="col-sm-2 col-form-label"><svg xmlns="http://www.w3.org/2000/svg" width="16"
