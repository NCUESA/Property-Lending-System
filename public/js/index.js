        ...
        let card = `
            <div class="col">
                <div class="card">
                    ...
                    <img src="./storage/propertyImgs/${item.img_url}" style="width: 100%; aspect-ratio: 16 / 9; object-fit: contain;" class="card-img-top" alt="No Image" onerror="this.src='https://dummyimage.com/1920x1080/cccccc/000000&text=No+Image';">
                    <div class="card-body">
